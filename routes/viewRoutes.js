...
Router.get('/buildings-near-me/:latlng/unit/:unit',authController.isLoggedIn, viewsController.getBuildingsNearMe);

Router.get('/buildings-within-distance/:distance/center/:latlng/unit/:unit',authController.isLoggedIn, viewsController.getBuildingsWithinDistance);
